...
ActiveRecord::Schema.define(version: 20140626193722) do
  ...
  add_index "donations", ["stripe_amount"], name: "index_donations_on_stripe_amount", using: :btree
  add_index "donations", ["stripe_amount_refunded"], name: "index_donations_on_stripe_amount_refunded", using: :btree
  add_index "donations", ["stripe_application_fee"], name: "index_donations_on_stripe_application_fee", using: :btree
  add_index "donations", ["stripe_balance_transaction"], name: "index_donations_on_stripe_balance_transaction", using: :btree
